...
export default {
  ...
  data: function () {
    return {
      orderList: [
        {
          icon: require("../../assets/images/profile/message.svg"),
          info: "我的消息",
        },
        {
          icon: require("../../assets/images/profile/pointer.svg"),
          info: "积分商城",
        },
        {
          icon: require("../../assets/images/profile/vip.svg"),
          info: "会员卡",
        },
      ],
      serviceList: [
        {
          icon: require("../../assets/images/profile/cart.svg"),
          info: "我的购物车",
        },
        {
          icon: require("../../assets/images/profile/shopping.svg"),
          info: "下载购物APP",
        },
      ],
    };
